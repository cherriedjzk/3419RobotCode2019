 ...
 */
public class Robot extends SampleRobot implements IMechanism<Robot>{
  private static final String kDefaultAuto = "Default";
  private static final String kCustomAuto = "My Auto";

  public Mechanism<Drivetrain> Drivetrain;
  public Mechanism<HatchIntake> HatchIntake;

  public static final int IDLE = 0;
  public static final State<Robot> STATE_IDLE = new State<Robot>("IDLE", IDLE);

  public void TransitionTo(State<Robot> state) {
    switch(state.Value) {
      case IDLE:
